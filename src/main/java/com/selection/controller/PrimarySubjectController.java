...
@Controller
@RequestMapping("/api/admin/primarysubject")
public class PrimarySubjectController {
     ...
     * 路由地址
     */
    public String prefix = "/view/admin/primarysubject";

    /**
     * 业务层
     */
    @Autowired
    private IPrimarySubjectService service;
    ...
    @RequestMapping("/list")
    @ResponseBody
    public Result getList(QPage qPage, PrimarySubject obj) {
    ...
    @ResponseBody
    public Result insert(PrimarySubject obj) {
    ...
    public Result getById(Integer id) {
        PrimarySubject dbo=this.service.getByIds(id);
    ...
    @ResponseBody
    public Result updates(PrimarySubject obj) {
